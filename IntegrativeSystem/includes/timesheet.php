...
<body id="printData">
    ...
    <div class="container ps-5 pe-5 ">
        ...
        <div class="text-center">
            <button class="btn btn-success printInfo" name="submit" data-employeeid="<?php echo $empID; ?>">Print
            DTR</button>
    </div>
    ...
    <script>
        $(document).ready(function () {
            $('.printInfo').click(function () {
                ...
                $.ajax({
                    url: '../includes/printTimesheet.php',
                    type: 'post',
                    data: { userid: userid },
                    success: function (response) {
                        // Open the print.php page in a new window with the userid parameter
                        var url = '../includes/printTimesheet.php?userid=' + encodeURIComponent(userid);
